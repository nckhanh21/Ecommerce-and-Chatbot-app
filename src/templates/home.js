            ...
            <div className="tw-container grid lg:grid-cols-2 place-items-center gap-x-32">
                <article>
                    ...
                    <p className="mt-8 max-w-lg leading-loose ">
                        Sẵn sàng biến bạn trở thành 1 quý tộc
                    </p>
                ...
                <article id="showcase-image" className="relative hidden lg:block">
                    <img 
                        ...
                        src="https://img01.ztat.net/article/spp-media-p1/36131c97d5e53cd6a843ec50ae2bd78b/bb5d63a458994098902bee5be9bd074c.jpg?imwidth=1800"
                    />
                    <img
                        ...
                        src="https://cf.shopee.vn/file/4b0bb8198a0d514e0989386d2c440e71"
                    />
                </article>
            </div>
        </section>
            ...
            <div className="tw-container py-14">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    <Panel
                        ...
                        name="Áo Hoodie Gấu Thu Đông"
                        image="https://cf.shopee.vn/file/sg-11134201-22100-2ccsdcy96riv24"
                        price={250000}
                    />
                    <Panel
                        id="rec7JInsuCEHgmaGe"
                        name="Áo Khoác Dạ Nữ"
                        image="https://cf.shopee.vn/file/feadbc05439cbdb048d7c24904aba9eb"
                        price={79999}
                    />
                    <Panel
                        id="recNZ0koOqEmilmoz"
                        name="Blazer Nam"
                        image="https://cf.shopee.vn/file/sg-11134201-22100-kgwxgifmusiv65"
                        price={59999}
                    />
                </div>
        ...
        <section id="services" className="bg-blue-400">
            <div className="transform py-20 xl:py-0 xl:translate-y-20 tw-container text-blue-50">
                <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 items-center gap-y-4">
                    <h3 className="font-bold">Custom Style<br/>Built Only For You</h3>
                    <p className="leading-7">Biến bạn từ một người có style phèn chúa như Hoàng Chu trở thành 1 quý's tộc's</p>
                </div>
                <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 text-center gap-10">
                    <ServiceBox title="Mission" content={'Chúng tôi là những chuyên gia về thời trang'} >
                    ...
                    <ServiceBox title="Vision" content={"Chat bot sử dụng trí tuệ nhân tạo để gợi ý trang phục"}>
                    ...
                    <ServiceBox title="Sản phẩm" content={"Chúng tôi có sẵn 500 trang phục khác nhau cho bạn thoải mái lựa chọn"}>
            ...
            <div className="tw-container my-16 md:my-32 lg:my-64">
                ...
                <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 items-center gap-x-32">
                    <p className="leading-7 mt-8 max-w-lg opacity-60">
                        Còn chần chờ gì nữa mà không vào đây lựa một bộ quần áo thật đẹp nào 
                    </p>
